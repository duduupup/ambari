...
cluster_zookeeper_quorum_hosts = config['configurations']['ams-site']['cluster_zookeeper_quorum_hosts']
cluster_zookeeper_clientPort = config['configurations']['ams-site']['cluster_zookeeper_clientPort']
